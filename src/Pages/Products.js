      ...
      <div>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-10">
              <div className="mx-auto max-w-2xl lg:mx-0 ">
                ...
                <p className="mt-8 text-lg font-medium text-white sm:text-xl">
                  ...
                  crafted with love and the finest ingredients to make your
        ...
        <div className="bg-white">
          <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            ...
            <p className="mt-4 text-lg text-darkbrown max-w-prose">
              Our wedding cakes are designed to add a touch of elegance and
              romance to your special day. Each cake is crafted with attention
              to detail and a passion for perfection.
            </p>
            <div className="grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
              {weddingCakes.map((product) => (
                ...
                >
                  ...
                  <h3 className="mt-4 text-sm text-darkbrown">
                    {product.name}
                  </h3>
                  <p className="mt-1 text-lg font-medium text-darkbrown">
                    {product.price}
                  </p>
                </div>
              ))}
        ...
        <div className="bg-white">
          <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            ...
            <p className="mt-4 text-lg text-darkbrown max-w-prose">
              Our cupcakes are perfect for any occasion, from birthdays to
              everyday indulgence. Each cupcake is made with the finest
              ingredients and decorated with care.
            </p>
            <div className="grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
