...
function Home() {
  return (
    <>
      <Helmet>
        <title>Munamii Cakery - Home Page</title>
      </Helmet>
      <header>
        <div className="relative isolate overflow-hidden bg-darkgreen px-6 pt-16 shadow-2xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md  lg:mx-0 lg:flex-auto lg:py-32 text-left">
            ...
            <p className=" text-pretty text-lg/8 text-white">
              Welcome to Munamii Cakery! We specialize in creating delightful
              cupcakes and exquisite wedding cakes that add a touch of sweetness
          ...
          <div className="relative mt-16 h-80 lg:mt-8">
            <img
              alt="Exclusive wedding cake with roses and gold decorations"
              src={weddingCake}
              className="absolute -left-60 top-0 w-[57rem] max-w-none"
            />
          </div>
        </div>
      </header>
