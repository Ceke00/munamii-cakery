					...
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						<div className="mx-auto max-w-2xl lg:mx-0">
							...
							<p className="mt-8 text-lg font-medium text-white sm:text-xl">
								Welcome to Munamii Cakery, where we create delightful and whimsical cupcakes and exquisite,
								romantic wedding cakes. Our passion is to bring joy and sweetness to your special moments.
							</p>
						</div>
					</div>
				</div>
						...
						<div className="lg:pr-4">
							<div className="lg:max-w-lg">
								...
								<p className="mt-6 text-xl leading-8 text-darkbrown">
									Munamii Cakery started as a small Instagram shop, sharing our love for baking with the world.
									Our founder, Munamii, has always had a passion for creating beautiful and delicious treats.
									From cute and creative cupcakes to luxurious and romantic wedding cakes, every creation is
					...
					<div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
						<div className="lg:pr-4">
							<div className="max-w-xl text-base leading-7 text-darkbrown lg:max-w-lg">
								<p>
									At Munamii Cakery, we believe that every celebration deserves a touch of sweetness. Our
									cupcakes are perfect for birthdays, parties, and everyday indulgence, while our wedding cakes
									add a magical touch to your special day.
								</p>
								<p className="mt-8">
									We take pride in using high-quality ingredients and crafting each cake and cupcake with care.
									Our goal is to create not just a dessert, but a memorable experience for you and your loved
									ones.
								</p>
								...
								<p className="mt-6">
									Follow us on Instagram to see our latest creations and get inspired for your next event. We
									look forward to bringing a little bit of sweetness into your life!
								</p>
							</div>
						</div>
					</div>
