            ...
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-xl leading-8 text-darkbrown">
                  Munamii Cakery started as a small Instagram shop, sharing our
                  love for baking with the world. Our founder, Munamii, has
                  always had a passion for creating beautiful and delicious
                  treats. From cute and creative cupcakes to luxurious and
                  romantic wedding cakes, every creation is made with love and
                  attention to detail.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="max-w-xl text-base leading-7 text-darkbrown lg:max-w-lg">
                <p>
                  At Munamii Cakery, we believe that every celebration deserves
                  a touch of sweetness. Our cupcakes are perfect for birthdays,
                  parties, and everyday indulgence, while our wedding cakes add
