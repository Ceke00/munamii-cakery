	...
	return (
		<div className="p-10">
			...
			<p className="mt-1 text-sm leading-6 text-darkbrown max-w-prose">
				We'd love to hear from you! Whether you have questions about our delicious cupcakes and cakes, or you want
			...
			<form onSubmit={handleSubmit}>
				<div className="space-y-12">
					<div className="pb-12">
						<div className="">
							<div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
								<div className="sm:col-span-3">
									<label htmlFor="first-name" className="block text-sm font-medium leading-6 text-darkbrown">
										First name
									</label>
									<div className="mt-2">
										<input
								...
								<div className="sm:col-span-3">
									<label htmlFor="last-name" className="block text-sm font-medium leading-6 text-darkbrown">
										Last name
									</label>
									<div className="mt-2">
										<input
								...
								<div className="sm:col-span-4">
									<label htmlFor="email" className="block text-sm font-medium leading-6 text-darkbrown">
										Email address
									</label>
									<div className="mt-2">
										<input
								...
								<div className="sm:col-span-4">
									<label htmlFor="phone" className="block text-sm font-medium leading-6 text-darkbrown">
										Phone number
									</label>
									<div className="mt-2">
										<input
								...
								<div className="sm:col-span-2 sm:col-start-1">
									<label htmlFor="city" className="block text-sm font-medium leading-6 text-darkbrown">
										City
									</label>
									<div className="mt-2">
										<input
								...
								<div className="sm:col-span-2">
									<label htmlFor="postal-code" className="block text-sm font-medium leading-6 text-darkbrown">
										ZIP / Postal code
									</label>
									<div className="mt-2">
										<input
						...
						<div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
							<div className="col-span-full">
								<label htmlFor="question" className="block text-sm font-medium leading-6 text-darkbrown">
									Question
								</label>
